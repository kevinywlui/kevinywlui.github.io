...
\begin{questions}
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            \[
                x_1b_1+x_2b_2 = y.
            \]
           This yields the linear systemg
        \end{solution}
        \vfill
        \vfill
        \vfill
    ...
    \begin{parts}
        ...
        \begin{solution}
            ...
            I_2$. Then $\col(A)=\col(B)=\mathbb{R}^n$ and
            $\nll(A)=\nll(B)=\{0\}$.
        \end{solution}
        \vfill
        \part[3]
    ...
    \begin{parts}
        ...
        \begin{solution}
            Relations among the columans of $A$ are also relations among the
            columns of $B$. This means
            \[
